...
#[utoipa::path(
    ...
    responses(
        (status = StatusCode::OK, description = "An email was sent successfully", body = ResponseJson, example = json!("{\"message\": \"The email was sent successfully!\", \"redirect\": \"http://localhost/success.html\"}")),
...
pub async fn dispatch_email(Json(payload): Json<EmailPayload>) -> DefaultResponse {
    ...
    DefaultResponse {
        ...
        message: Some("An email was sent successfully!".to_string()),
        redirect: None,
    }
}
